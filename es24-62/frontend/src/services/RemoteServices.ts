...
export default class RemoteServices {
  ...
  static async getParticipationsByActivity(
    activityId: number,
  ...
  static async getAssessmentsByVolunteer(): Promise<Assessment[]> {
    return httpClient
  ...
  static async getParticipationsByVolunteer(): Promise<Participation[]> {
    return httpClient
